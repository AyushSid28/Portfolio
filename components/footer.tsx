...
export default function Footer() {
  ...
  const footerLinks = [
    ...
    },
    {
      title: "Connect",
      links: [
        { name: "GitHub", href: "https://github.com/AyushSid28" },
          ...
          <div className="md:col-span-2">
            <Link href="/" className="group mb-4 inline-block">
              <div className="relative">
                <span className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-violet-500 to-fuchsia-500 font-mono tracking-tight">
                  AyushSid.dev
                </span>
                <div className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-violet-500 to-fuchsia-500 group-hover:w-full transition-all duration-300"></div>
              </div>
            </Link>
            <p className="text-gray-400 mb-4 max-w-md">
              Backend Engineer & AI Systems Specialist passionate about building scalable systems and integrating next-generation AI solutions.
            </p>
            <button
              onClick={scrollToTop}
