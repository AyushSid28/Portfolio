...
export default function VoiceAssistant() {
  ...
  >([
    {
      role: "assistant",
      content: "Hi there! I'm Goku, your AI assistant. Ask me anything about Ayush Siddhant.",
    },
  ])
  ...
  const suggestedQuestions = [
    ...
    "Tell me about Ayush's projects",
    "What is Ayush's specialization?",
    "What is Ayush's experience with AI?",
    "What legal tech projects has Ayush built?",
  ]
                  ...
                  {showVoicePrompt && (
                    ...
                    >
                      <div className="flex items-start">
                        ...
                        <div>
                          <h4 className="font-medium text-white mb-1">Voice-Powered Goku</h4>
                          <p className="text-sm text-gray-200 mb-3">
                            Click the microphone button and speak. I'll listen, understand, and respond with Ayush's
                            voice!
                          </p>
